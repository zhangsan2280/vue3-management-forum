...
<script lang="ts" setup>
    ...
    const page = (page:number) => {
        ...
        router.push({
            path: '/admin/control/questionLike/list', 
            query:{ 
