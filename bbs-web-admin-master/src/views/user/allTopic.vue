...
<template>
    <div class="main">
        <div class="navbar">
            ...
            <el-button type="primary" plain v-if="verifyPermissionMenu('/control/topic/manage?method=reduction*','post')" @click="reductionTopic($event)">还原</el-button>
...
<script lang="ts" setup>
    ...
    const page = (page:number) => {
        ...
        router.push({
            path: '/admin/control/user/manage/allTopic', 
            query:{ 
                id:state.id,
