        ...
        <div class="data-form label-width-blank userModule" >
            <el-form label-width="auto"  @submit.native.prevent>
                <el-form-item label="账号" :required="true" :error="error.userAccount">
                    <el-col :span="12"><el-input v-model.trim="state.userAccount" maxlength="20" :clearable="true" show-word-limit></el-input></el-col>
                </el-form-item>
...
<script lang="ts" setup>
    ...
    const submitForm = () => {
        ...
        formData.append('userAccount', state.userAccount);
