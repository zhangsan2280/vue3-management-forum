        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="模板目录" :required="true" :error="error.dirName">
                    <el-col :span="12">{{state.dirName}}</el-col>
                </el-form-item>
...
<script lang="ts" setup>
    ...
    const state = reactive({
        ...
        images:[] as UploadUserFile[],//上传的文件列表
            ...
            if(response){
                ...
                if(result){
                    ...
                    if(returnValue.code === 200){//成功
			    		...
			    		if(templates != null){
			    			state.name =templates.name;
							state.introduction = templates.introduction;
							state.verifyCSRF = templates.verifyCSRF;
			    			if(templates.thumbnailSuffix != null && templates.thumbnailSuffix != ''){
			    				state.imagePath = store.apiUrl+"common/"+ templates.dirName +"/templates."+templates.thumbnailSuffix;
			    				state.images.push({
